        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Homes_Accounts_AccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EndsAfter = table.Column<int>(type: "integer", nullable: true),
                    RecurrenceJson = table.Column<string>(type: "text", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    LastGeneratedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpenseRecurrences", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExpenseRecurrences_Homes_HomeId",
                        column: x => x.HomeId,
                        principalTable: "Homes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExpenseRecurrences_Members_CreatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Expenses_ExpenseRecurrences_RecurrenceId",
                        column: x => x.RecurrenceId,
                        principalTable: "ExpenseRecurrences",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Expenses_Members_RegisteredById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Splits_Members_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpenseRecurrences_CreatedById",
                table: "ExpenseRecurrences",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_ExpenseRecurrences_HomeId",
                table: "ExpenseRecurrences",
                column: "HomeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Expenses_RegisteredById",
                table: "Expenses",
                column: "RegisteredById");

            migrationBuilder.CreateIndex(
                name: "IX_Homes_AccountId",
                table: "Homes",
                column: "AccountId",
                unique: true);
